...
def get_skills_path() -> str:
    skills_dir = files("archivebox_api") / "skills"
...
def get_mcp_config_path() -> str:
    mcp_config_file = files("archivebox_api") / "mcp_config.json"
                ...
                try:
                    with open(skill_file, "r") as f:
                        ...
                        if content.startswith("---"):
                            ...
                            tag_name = skill_id.replace("archivebox-", "")
                            tags = ["archivebox", tag_name]
