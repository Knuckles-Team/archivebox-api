...
def usage():
    print(
        f"Archivebox Api ({__version__}): CLI Tool\n\n"
        "Usage:\n"
        ...
        "\n"
        "Examples:\n"
        "  [Simple]  archivebox-agent \n"
        '  [Complex] archivebox-agent --host "value" --port "value" --debug "value" --reload --provider "value" --model-id "value" --base-url "value" --api-key "value" --mcp-url "value" --mcp-config "value" --custom-skills-directory "value" --web\n'
    )
