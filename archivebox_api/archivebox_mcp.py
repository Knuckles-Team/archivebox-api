...
def archivebox_mcp():
    ...
    parser = argparse.ArgumentParser(
        add_help=False, description="ArchiveBox MCP Runner"
    )
    parser.add_argument(
        "-t",
        "--transport",
...
def usage():
    print(
        f"Archivebox Api ({__version__}): ArchiveBox MCP Runner\n\n"
        "Usage:\n"
        ...
        "--required-scopes                  [ Comma-separated list of required scopes (e.g., archivebox.read,archivebox.write). ]\n"
