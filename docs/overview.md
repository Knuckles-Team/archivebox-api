# archivebox-api — Concept Overview
...
```json
{
  "mcpServers": {
    "archivebox-api": {
      "command": "uv",
      "args": ["run", "--with", "archivebox-api", "archivebox-mcp"],
      "env": {}
    }
  }
}
...
```bash
archivebox-mcp --transport streamable-http --port 8001
```
