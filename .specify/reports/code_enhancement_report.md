...
| externalized_prompts | 0 | `${WORKSPACE_ROOT}/agent-packages/agents/archivebox-api` | No prompts/ directory found. Prompts may be hardcoded in source. |
...
| agents_md | 10 | `${WORKSPACE_ROOT}/agent-packages/agents/archivebox-api/AG` | AGENTS.md exists with comprehensive content |
| pre_commit_hooks | 10 | `${WORKSPACE_ROOT}/agent-packages/agents/archivebox-api/.p` | Pre-commit configuration found for automated code quality checks |
| gitignore | 10 | `${WORKSPACE_ROOT}/agent-packages/agents/archivebox-api/.g` | .gitignore exists to prevent committing build artifacts and secrets |
| env_template | 10 | `${WORKSPACE_ROOT}/agent-packages/agents/archivebox-api/.e` | Environment template exists for onboarding and secret management |
...
| Criterion | Points | Evidence | Reasoning |
|-----------|--------|----------|-----------|
| dependency_freshness | 100 | `source=${WORKSPACE_ROOT}/agent-packages/agents/archivebox` | Audited 5 deps (5 installed, 0 constraint-only). 0 major, 0 minor, 0 patch updat |
...
| Criterion | Points | Evidence | Reasoning |
|-----------|--------|----------|-----------|
| bumpversion_exists | 20 | `${WORKSPACE_ROOT}/agent-packages/agents/archivebox-api/.b` | .bumpversion.cfg found |
