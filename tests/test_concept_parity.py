...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/archivebox-api"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in archivebox-api
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in archivebox-api but are NOT registered "
